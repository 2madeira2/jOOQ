...
public class WaybillRecord extends UpdatableRecordImpl<WaybillRecord> implements Record3<Integer, LocalDate, String> {
    ...
    @Override
    public WaybillRecord values(Integer value1, LocalDate value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public WaybillRecord(Integer waybillNum, LocalDate waybillDate, String orgSender) {
        super(Waybill.WAYBILL);
