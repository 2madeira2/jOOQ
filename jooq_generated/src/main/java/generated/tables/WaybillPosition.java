...
public class WaybillPosition extends TableImpl<WaybillPositionRecord> {
    ...
    public List<ForeignKey<WaybillPositionRecord, ?>> getReferences() {
        return Arrays.asList(Keys.WAYBILL_POSITION__NOMENCLATURE_FKEY, Keys.WAYBILL_POSITION__WAYBILL_FKEY);
    }

    private transient Nomenclature _nomenclature;
    private transient Waybill _waybill;

    public Nomenclature nomenclature() {
        if (_nomenclature == null)
            _nomenclature = new Nomenclature(this, Keys.WAYBILL_POSITION__NOMENCLATURE_FKEY);
    ...
    public Waybill waybill() {
        if (_waybill == null)
            _waybill = new Waybill(this, Keys.WAYBILL_POSITION__WAYBILL_FKEY);
