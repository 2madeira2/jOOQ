...
public class Waybill extends TableImpl<WaybillRecord> {
     ...
     */
    public final TableField<WaybillRecord, LocalDate> WAYBILL_DATE = createField(DSL.name("waybill_date"), SQLDataType.LOCALDATE, this, "");
    ...
    public List<ForeignKey<WaybillRecord, ?>> getReferences() {
        return Arrays.asList(Keys.WAYBILL__ORG_SENDER_FKEY);
    }
    ...
    public Organization organization() {
        if (_organization == null)
            _organization = new Organization(this, Keys.WAYBILL__ORG_SENDER_FKEY);
